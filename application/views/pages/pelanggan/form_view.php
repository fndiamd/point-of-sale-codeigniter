            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" readonly class="form-control" id="nama_pelanggan" name="nama_pelanggan" value="<?php echo $data->nama_pelanggan ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" readonly class="form-control" id="status" name="status" value="<?php echo $data->status ?>">
                    </div>
